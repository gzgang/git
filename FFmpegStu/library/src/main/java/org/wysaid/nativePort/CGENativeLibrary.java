...
public class CGENativeLibrary {
    ...
    public interface LoadImageCallback {
        ...
        void generateVideoCallback(int percent);
    }
    ...
    public static void generateVideoCallback(int percent) {
        Log.i(Common.LOG_TAG, "generateVideoCallback percent = " + percent+"%");
        if (null != loadImageCallback) {
            loadImageCallback.generateVideoCallback(percent);
        }
    }
